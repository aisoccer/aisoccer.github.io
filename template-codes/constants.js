...
+ '            # Robot Functions\n'
+ '            self.speeds[5 * self.gk_index : 5 * self.gk_index + 5] = self.GK.move(self.gk_index, \n'
...
+ '            self.speeds[5 * self.d1_index : 5 * self.d1_index + 5] = self.D1.move(self.d1_index, \n'
+ '                                                                                self.idx, self.idx_opp, \n'
+ '                                                                                self.defense_angle, self.attack_angle,\n'
+ '                                                                                self.cur_posture, self.cur_posture_opp,\n'
+ '                                                                                self.previous_ball, self.cur_ball, self.predicted_ball)\n'
+ '            self.speeds[5 * self.d2_index : 5 * self.d2_index + 5] = self.D2.move(self.d2_index, \n'
+ '                                                                                self.idx, self.idx_opp, \n'
+ '                                                                                self.defense_angle, self.attack_angle,\n'
+ '                                                                                self.cur_posture, self.cur_posture_opp,\n'
+ '                                                                                self.previous_ball, self.cur_ball, self.predicted_ball)\n'
+ '            self.speeds[5 * self.f1_index : 5 * self.f1_index + 5] = self.F1.move(self.f1_index, \n'
+ '                                                                                self.idx, self.idx_opp, \n'
+ '                                                                                self.defense_angle, self.attack_angle,\n'
+ '                                                                                self.cur_posture, self.cur_posture_opp,\n'
+ '                                                                                self.previous_ball, self.cur_ball, self.predicted_ball)\n'
+ '            self.speeds[5 * self.f2_index : 5 * self.f2_index + 5] = self.F2.move(self.f2_index, \n'
+ '                                                                                self.idx, self.idx_opp, \n'
+ '                                                                                self.defense_angle, self.attack_angle,\n'
+ '                                                                                self.cur_posture, self.cur_posture_opp,\n'
+ '                                                                                self.previous_ball, self.cur_ball, self.predicted_ball)\n'
